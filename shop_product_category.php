...
$query = "SELECT * FROM products where p_cat_id = $id LIMIT $limit OFFSET $offset";
...
$totalQuery = "SELECT COUNT(*) as total FROM products where p_cat_id = $id";
        ...
        <a href="add_to_wishlist?product_id=' . $post["product_id"] . '"><i class="fa-light fa-heart"></i></a>
            ...
            <div class="col-lg-3">
              <aside class="sidebar style_2">
                ...
                <div class="widget">
                  <h3 class="widget_title">Featured Products</h3>
